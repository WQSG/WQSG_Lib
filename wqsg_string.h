...
/**********************************************************************
**********************************************************************/
//union WQSG_U6432{struct{u32 LowPart;u32 HighPart;};	u64 QuadPart;};
...
//-------------------------------------------------------------------------------
#if 0
inline int	WQSG_strstrEx( char const*const TXT , const int T_len , char const*const FIND , const int _F_len )
{
	if(!_F_len)
		return (int)0;
...
//-------------------------------------------------------------------------------
#if 0
inline int	WQSG_strstrEx( WCHAR const*const TXT , const int T_len , WCHAR const*const FIND , const int _F_len )
{
	if(!_F_len)	return (int)0;
